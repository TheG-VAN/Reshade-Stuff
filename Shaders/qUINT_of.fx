...
{	
	o = 0;//showmotion(-tex2D(sMotionTexIntermediate0, i.uv).xy);
}
...
{
	pass {VertexShader = PostProcessVS;PixelShader  = PSWriteFeature; RenderTarget = FeaturePyramid; } 

	pass {VertexShader = PostProcessVS;PixelShader = PSMotion6;RenderTarget = MotionTexIntermediate6;}
    pass {VertexShader = PostProcessVS;PixelShader = PSMotion5;RenderTarget = MotionTexIntermediate5;}
    pass {VertexShader = PostProcessVS;PixelShader = PSMotion4;RenderTarget = MotionTexIntermediate4;}
    pass {VertexShader = PostProcessVS;PixelShader = PSMotion3;RenderTarget = MotionTexIntermediate3;}
    pass {VertexShader = PostProcessVS;PixelShader = PSMotion2;RenderTarget = MotionTexIntermediate2;}
    pass {VertexShader = PostProcessVS;PixelShader = PSMotion1;RenderTarget = MotionTexIntermediate1;}
    pass {VertexShader = PostProcessVS;PixelShader = PSMotion0;RenderTarget = MotionTexIntermediate0;}

	pass {VertexShader = PostProcessVS;PixelShader  = PSWriteFeature; RenderTarget = FeaturePyramidPrev; }
	//pass {VertexShader = PostProcessVS;PixelShader  = PSOut;  }  
}